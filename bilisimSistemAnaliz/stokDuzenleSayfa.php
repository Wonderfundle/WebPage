                    ...
                    <section class="content">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">Stok Düzenle</h3>
                            </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <select class="form-control" id="urun_id" required>
                                                    <?php
                                                    ...
                                                    if ($result->num_rows > 0) {
                                                        while ($row = $result->fetch_assoc()) {
                                                            echo '<option value="' . htmlspecialchars($row["urun_id"]) . '">' . htmlspecialchars($row["urun_adi"]) . '</option>';
                                                        }
                                                    } else {
                                ...
                                <div class="col">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <select class="form-control" id="depo_id" name="depo_id" required>
                                                <?php
                                                include '02_baglan.php';
                                                ...
                                                if ($result->num_rows > 0) {
                                                    while ($row = $result->fetch_assoc()) {
                                                        echo '<option value="' . htmlspecialchars($row["depo_id"]) . '">' . htmlspecialchars($row["depo_adi"]) . '</option>';
                                                    }
                                                } else {
                                                    echo '<option value="">Veritabanında depo bulunamadı.</option>';
                                                }
                                ...
                                <div class="row">
                                    <div class="col">
                                        <div class="form-group row">
                                            <label>Miktar</label>
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" id="miktar" required>
                                            </div>
                                        </div>
                                    </div>
                                </div>
